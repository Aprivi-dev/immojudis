...
| Enquête dossier supervisée                                             | Demandeurs et contacts professionnels ; email de réponse, coordonnées publiques ou renseignées, annonce, questions, messages, réponses et preuve d’approbation      | Obtenir, sur instruction et après validation de l’utilisateur, des informations utiles sur une vente                  | Contrat ; consentement pour communiquer l’email de réponse                                        | Immojudis, Supabase, Resend, professionnel choisi                   | Suivi actif ; sans activité, brouillons 6 mois et échanges 24 mois                          | Garanties Resend/Supabase et localisation du destinataire |
...
- contrôler que l’enquête dossier conserve une validation par message, révèle l’usage de l’IA au
  destinataire et ne transmet ni plafond d’enchère ni données financières par défaut ;
